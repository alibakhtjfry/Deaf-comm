...
**Real-Time Speech ↔ Sign Language Communication System**
...
* `main` – Consolidated and stable implementation
* Supporting directories – AI models, avatar system, backend services, and mobile UI components
...
* ✔ Speech and text to sign language conversion
* ✔ Deep learning-based gesture recognition
* ✔ Progressive transformer-based motion prediction
* ✔ 3D avatar visualization for sign output
* ✔ MediaPipe-based hand landmark extraction
* ✔ Backend API layer for model integration
* ✔ Mobile-friendly user interface
* ✔ Performance evaluation using accuracy, SER, and latency metrics
...
* **Text-to-Sign Translation:** Transformer Encoder–Decoder Architecture
...
🌍 **DeafComm — enabling inclusive communication through intelligent technology.**
